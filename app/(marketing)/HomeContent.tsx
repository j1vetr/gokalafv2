...
import { ArrowRight, ChevronRight, Target, Activity, Trophy, ChevronLeft } from 'lucide-react';
...
export function HomeContent() {
  ...
  return (
    <div className="overflow-hidden bg-[#050505]">
      {/* HERO SECTION */}
      <section className="relative min-h-[100svh] flex flex-col lg:flex-row items-center pt-20 lg:pt-0 overflow-hidden">
          ...
          <div className="lg:w-1/2 relative z-30 text-center lg:text-left pt-[12vh] sm:pt-[14vh] md:pt-[16vh] lg:pt-0 lg:pr-12">
            <div>
              ...
              >
                ...
                <div className="flex flex-col items-start relative z-10">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-heading font-black text-xl tracking-widest px-3 py-1 bg-gradient-to-r from-primary to-[#a8e600] text-black rounded-lg shadow-lg shadow-primary/30">
                      ALAF10
                    </span>
                  </div>
                </div>
              ...
              <div className="relative inline-block mb-3 lg:mb-4 p-4 sm:p-6 lg:p-8">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[90px] font-heading font-bold leading-[1.1] tracking-tighter uppercase text-white drop-shadow-2xl relative z-10">
                  ...
                  <span className="relative inline-block">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#eaff80] to-primary text-glow animate-gradient-x bg-[length:200%_auto] relative z-10">
                      Sistem
                    </span>
                  </span>
                </h1>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-400 max-w-xs sm:max-w-md mx-auto lg:mx-0 leading-relaxed font-light mb-4 lg:mb-8">
                Bilimsel veriler, kişiselleştirilmiş stratejiler ve disiplinli takip sistemiyle
                potansiyelini açığa çıkar.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start w-full sm:w-auto">
                <Link href="/paketler">
                  <button className="w-full sm:w-auto bg-primary text-black hover:bg-primary/90 font-heading font-bold uppercase tracking-wide text-base md:text-lg h-12 md:h-14 px-8 rounded-md shadow-[0_0_20px_rgba(204,255,0,0.3)] hover:shadow-[0_0_30px_rgba(204,255,0,0.5)] transition-all relative overflow-hidden group">
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-white/30 flex flex-col items-center gap-2 z-20 hidden lg:flex animate-bounce">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="relative z-10">
                <div
                  className={`bg-[#0A0A0A] border p-8 rounded-3xl transition-all duration-700 h-full relative overflow-hidden shadow-2xl ${
                    i === activeStep
                ...
                >
                  ...
                  >
                    <div
                      className="absolute inset-[-50%] bg-[conic-gradient(from_0deg,transparent_0deg,transparent_90deg,#ccff00_180deg,transparent_270deg,transparent_360deg)] animate-spin-slow-linear"
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent transition-opacity duration-700 z-10 ${
                      i === activeStep ? 'opacity-100' : 'opacity-0'
                    }`}
                  ></div>
                  ...
                  <div className="relative z-20">
                    <div className="flex justify-between items-start mb-8 relative">
                      <div
                        className={`w-20 h-20 rounded-2xl flex items-center justify-center transition-all duration-700 shadow-lg ${
                          i === activeStep
                      ...
                      <span
                        className={`text-6xl font-heading font-bold transition-colors duration-700 select-none ${
                    ...
                    <h3
                      className={`text-2xl font-heading font-bold uppercase mb-4 transition-colors duration-700 relative ${
                        i === activeStep ? 'text-primary' : 'text-white'
                      }`}
                    >
                      {item.title}
                    </h3>
                    <p className="text-gray-400 leading-relaxed relative">{item.desc}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="relative inline-flex mx-auto p-2 md:p-3 rounded-2xl bg-gradient-to-b from-primary/30 via-primary/10 to-primary/30 shadow-2xl shadow-black/50">
              <div className="relative rounded-xl overflow-hidden border-2 border-primary/40">
                <img
                  ...
                  className="block h-[500px] md:h-[650px] w-auto transition-opacity duration-300"
                />
          ...
          <Link href="/paketler">
            <button className="h-16 px-12 text-xl font-heading font-bold uppercase bg-primary text-black hover:bg-primary/90 shadow-[0_0_40px_rgba(204,255,0,0.4)] hover:shadow-[0_0_60px_rgba(204,255,0,0.6)] transition-all hover:scale-105 rounded-none -skew-x-12">
              <span className="skew-x-12 inline-flex items-center gap-3">
                Planı Seç ve Başla <ArrowRight className="w-6 h-6" />
              </span>
            </button>
          </Link>
        </div>
