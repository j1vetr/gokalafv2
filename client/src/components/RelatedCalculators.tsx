...
const allCalculators: CalculatorItem[] = [
  ...
  { slug: "gunluk-su-ihtiyaci-hesaplama", name: "Su Tüketimi", description: "Günlük su ihtiyacınızı hesaplayın" },
  { slug: "vucut-yagi-orani-hesaplama", name: "Vücut Yağ Oranı", description: "Yağ yüzdenizi öğrenin" },
  { slug: "gunluk-protein-ihtiyaci-hesaplama", name: "Protein İhtiyacı", description: "Günlük protein miktarınız" },
